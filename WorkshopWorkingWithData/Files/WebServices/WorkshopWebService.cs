...
namespace WorkshopWorkingWithData
{
    ...
    public class WorkshopWebService : BaseService, IReadOnlySessionState
    {
        ...
        {
            //http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/GetAllContacts?qt=0
            Timer.Start();
        ...
        {
            //http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/GetFilteredContacts?qt=0&email=k.krylov@creatio.com
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        public Stream GetAllDataReverseJoin(QuryType qt)
        {
            ...
            // Example to run: 
            // http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/GetAllDataReverseJoin?qt=1
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        {
            // http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/GetContactsWithMinutes?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        {
            // http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/UpdateContactName?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00&NewName=Kirill
            Timer.Start();
        ...
        {
            // http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/InsertSeveralContacts?qt=1
            Timer.Start();
            string result = string.Empty;
            switch (qt)
            {
        ...
        {
            // http://lqmfu-laptec-01:7010/0/rest/WorkshopWebService/DeleteContact?qt=1&ContactId=060b93d0-0b94-4967-af32-030ac0844ec9
            Timer.Start();
            string result = string.Empty;
            switch (qt)
            {
